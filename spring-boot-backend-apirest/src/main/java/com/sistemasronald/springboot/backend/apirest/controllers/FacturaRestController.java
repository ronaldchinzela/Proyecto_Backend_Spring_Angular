...
@CrossOrigin(origins = {"http://localhost:4200", "*"})//ANOTACIÓN OPCIONAL PARA ANGULAR. PARA INDICAR EL PUERTO QUE VA EJEUTAR EL FRONT Y "*" PARA INDICAR EL SERVIDOR EN PRODUCCIÓN.
@RestController
@RequestMapping("/api")
